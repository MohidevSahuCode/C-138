...
@app.route('/saved-data' , methods = ['POST'])
def save():
    ...
    with open("C:/Users/mohid/OneDrive/Desktop/Python Files/PRO-C136-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv", "a") as f:
